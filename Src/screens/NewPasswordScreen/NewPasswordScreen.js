...
const NewPasswordScreen = () => {
    ...
    const onConfirmNewPasswordPressed=()=>{console.warn('Confirm New Password Pressed')};
  return (
    <View style={styles.root}>
      ...
      <CustomButton  text="Confirm Password" onPress={onConfirmNewPasswordPressed} type="PRIMARY"/> 
